            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-300 text-sm">
                            Smart construction cost estimation for modern homeowners and builders.
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/saved" className="text-gray-400 hover:text-white">
                                    Saved Estimates
                                </Link>
                            </li>
                            <li>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2">
                            <li className="text-gray-400">
                                <Link href="mailto:info@resiestimator.com" className="hover:text-white">
                                    info@resiestimator.com
                                </Link>
                            </li>
                            <li className="text-gray-400">
                                +1 (555) 123-4567
                ...
                <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm">
                        &copy; {new Date().getFullYear()} ResiEstimator. All rights reserved.
                    </p>
